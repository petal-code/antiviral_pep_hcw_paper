# =============================================================================
# 01_analysis_appendix_combpar.R
#
...
#
# Arms (5 total):
#   full_obv50 ~ full_obv90         (9) : 100% coverage, 50-90% efficacy  -- Figure 2
#
# Coverage splines:
#   full      : 100% throughout
#
...
# Arm definitions
#
# full_obv50 ~ full_obv90     (5 arms) : 100% coverage, 50-90% efficacy  -- Figure 2
# =============================================================================
FULL_EFFICACIES  <- c(0.50, 0.60, 0.70, 0.80, 0.90)
...
message(sprintf("Total arms for Figure 2: %d", nrow(ARMS)))
print(ARMS$arm_name)
