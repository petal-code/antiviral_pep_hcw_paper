...
# N_WORKERS jobs, each handles PARTICLES_PER_WORKER particles x 2 scenarios x N_REPS reps
# =============================================================================
    ...
    for (sc_name in names(scenario_setups)) {
      ...
      for (r in seq_len(N_REPS)) {
        ...
        result <- list(
          ...
          tdf          = cases,         # full individual-level data for post-hoc OBV application
