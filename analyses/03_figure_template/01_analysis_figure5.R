...
#
# Arms (9 total):
#   full_obv10 ~ full_obv90         (9) : 100% coverage, 10-90% efficacy  -- Figure 5
#
# Coverage splines:
#   full      : 100% throughout
#
...
# Arm definitions
#
# full_obv10 ~ full_obv90     (9 arms) : 100% coverage, 10-90% efficacy  -- Figure 5
# =============================================================================
...
message(sprintf("Total arms for Figure 5: %d", nrow(ARMS)))
print(ARMS$arm_name)
