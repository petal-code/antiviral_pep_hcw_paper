# =============================================================================
# 02_extract_figure_supp_B.R
# Extract and save run summaries for Figure Supp B.
# Output: output_figgen/figure_supp_B_run_summary.csv
# =============================================================================
source(here::here("analyses", "03_figure_template", "helper_functions_figure_1to4.R"))
COVERAGE_GRID <- c(0.10, 0.30, 0.50, 0.70, 0.90)
EFFICACY_GRID <- c(0.50, 0.60, 0.70, 0.80, 0.90)
message("Extracting run summaries for figure supp B...")
...
save_figure_data(run_df, "figure_supp_B_run_summary.csv")
message("Figure Supp B data extraction complete.")