# =============================================================================
# 02_plot_figure_supp_c.R
# Visualise Figure Supp C sensitivity analysis results (Figure 3 sensitivity).
# Reads: output_figgen/figure_supp_C_run_summary2.csv
# =============================================================================
source(here::here("analyses", "03_figure_template", "helper_functions_figure_1to4.R"))
OUT_DIR <- here("figures")
dir.create(OUT_DIR, recursive = TRUE, showWarnings = FALSE)

sens_raw <- read.csv(here("output_figgen", "figure_supp_C_run_summary.csv"),
...
save_fig("figure_supp_C_heatmap_deaths", fig_heatmap_deaths, 12, 4.5)
...
fig_heatmap_days <- (
  ...
  plot_annotation(tag_levels = list(c("a ", "b ")))
save_fig("figure_supp_C_heatmap_days", fig_heatmap_days, 12, 4.5)

message("Figure Supp C heatmaps saved")
...
save_fig("figure_supp_C_boxplot_deaths", fig_boxplot_deaths, 14, 4)
message("Figure Supp C boxplot (deaths averted) saved")
...
save_fig("figure_supp_C_boxplot_days", fig_boxplot_days, 14, 4)
message("Figure Supp C boxplot (days lost averted) saved")
