# =============================================================================
# 02_extract_figure3_sensitivity.R
# Extract run summaries for Figure 3 sensitivity analysis.
# Reads RDS files from outputs/simulation/fig3sens/
# Output: output_figgen/figure_3_sens_run_summary.csv
# =============================================================================
...
save_figure_data(sens_df, "figure_3_sens_run_summary.csv")
message("Figure 3 sensitivity extraction complete.")