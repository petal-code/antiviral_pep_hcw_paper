...
source_sheet <- "Worst West Africa"
out_prefix <- "worst_west_africa_endpoint_constrained_zero_plateau"
stan_file <- paste0(out_prefix, "_endpoint_constrained_partial_pool.stan")

scenario_name <- "Worst_WestAfrica"
scenario_duration_days <- 357
n_pred <- 100
