# ============================================================
# Best East Africa composite scenario
...
source_sheet <- "Best East Africa"
out_prefix <- "best_east_africa_endpoint_constrained_zero_plateau"
stan_file <- paste0(out_prefix, "_endpoint_constrained_partial_pool.stan")

scenario_name <- "Best_Composite_EastAfrica"
scenario_duration_days <- 60
n_pred <- 100
