## =============================================================================
## calculate_model_approx_r0_new_approach.R
##
## Single-type (genPop-dominant) R0 approximation at t = 0 for the *revamped*
## NPI parameterisation, plus the inversion that turns a target (R0,
## prop_funeral) into offspring means.
##
## Key differences vs the HCW-risk version:
...
##
## Source setup_model_parameters_new_approach.R first; fiber must be loaded.
## =============================================================================
